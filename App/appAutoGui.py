...
model_path = "G:\\OpenCV\\module06-playing-games-using-hci\\Applications\\model\\res10_300x300_ssd_iter_140000.caffemodel"
prototxt_path = "G:\\OpenCV\\module06-playing-games-using-hci\\Applications\\model\\deploy.prototxt"
...
def checkRect(detected_faces, bbox):
    '''
    check for a detected face inside the bounding box at the centre of the frame.
